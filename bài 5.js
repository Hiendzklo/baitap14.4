...
let stringValue = variable1; // Không có lỗi, vì kiểu dữ liệu của variable1 là any, nó có thể gán cho mọi kiểu dữ liệu
...
if (typeof variable2 === "string") {
    let stringValue2 = variable2; // Không có lỗi, vì kiểu dữ liệu của variable2 đã được kiểm tra
}
